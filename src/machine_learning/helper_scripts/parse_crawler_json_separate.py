...
list_of_files = ["data_2.json", "data_2_incomplete.json", "data_3.json", "data_3.json", "data_4.json",
                 ...
                 "data_9.json", "data_10.json", "data_11.json", "data_12.json", "data_13.json", "data_14.json",
                 "data_15.json", "data_16.json", "data_17.json", "data_18.json", "data_19.json", "data_20.json",
                 "data_21.json", "data_22.json", "data_23.json", "data_24.json", "data_25.json"]

existing_frame = pd.read_csv('nomadlist_travel_info_separated.csv')
...
# def extract_members() -> set:
#     members = existing_frame['username'].to_list()
#     return members
...
def download_profile_data(members_set: set):
    ...
    for member in tqdm(members_set):
        ...
        arg_dict = {"username": member, "cities_visited": cities_visited, "coutries_visited": countries_visited,
                    "recommended_cities": recommended_city, "recommended_countries": recommended_country}
    ...
    df.to_csv("results_separate.csv", encoding='utf-8', index=False)
