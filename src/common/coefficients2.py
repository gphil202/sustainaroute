...
class AirTravelEmissionsPerPassengerKm(float, Enum):
    ...
    WTT_UK_TO_NON_EU_FIRST = 0.06477
    ...
    ECONOMY_AVERAGE = 0.16255
    PREMIUM_ECONOMY_AVERAGE = 0.25607
    BUSINESS_AVERAGE = 0.39319
    FIRST_AVERAGE = 0.64017
